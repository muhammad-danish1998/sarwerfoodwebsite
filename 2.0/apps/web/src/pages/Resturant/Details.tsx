...
export default function Details() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://liefermars.de/_api_ajax_menu.php?resturent_slug=${restaurantSlug}&resturent_code=${restuarantCode}`).then((response) => {
                      ...
                      <div className="p-0  lg:p-0">
                        <div className="flex lg:items-center  justify-between border-2">
                          <div className=" justify-center lg:ml-2 items-center">
                            <h1 className="title-font lg:text-2xl text-xl p-1 lg:p-0 font-medium text-gray-900 mb-3">{name}</h1>

                            {/* -------- review ------------  */}
                            <span className="flex items-center p-1 lg:p-0 ">
                              <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 " viewBox="0 0 24 24" style={{ color: "#FF8A00" }}>
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                              </svg>
                              <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4  lg:ml-2" viewBox="0 0 24 24" style={{ color: "#FF8A00" }}>
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                              </svg>
                              <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4  lg:ml-2" viewBox="0 0 24 24" style={{ color: "#FF8A00" }}>
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                          ...
                          <div>
                            ...
                            <div className="mt-0 p-2 ">
                              <img className="inline-block lg:h-24 lg:w-24 h-12 w-12 rounded-full" src={currentRestaurantImg} alt="" />
                            </div>
                          </div>
                        </div>
                          ...
                          {menuArray?.map((eachMenuCatergory) => (
                            <>
                              <div className="border-2 border-gray-400 p-4 rounded-lg mt-4 w-full" id={eachMenuCatergory?.["catname"]}>
                                <h1 className="lg:text-4xl text-xl font-bold text-black">{eachMenuCatergory?.["catname"]}</h1>
                              ...
                              {eachMenuCatergory?.menuarr.map((eachMenuItem) => (
                                <div
                                  ...
                                  onClick={() => {
                                    handleClick(eachMenuItem.id, eachMenuItem.price, eachMenuItem?.name, eachMenuItem?.description, eachMenuItem?.image);
                                  }}
                                >
                                  <div>
                                        ...
                                        modal()?.show(
                                            ...
                                            <div>
                                              <span className="flex justify-end ">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8 hover:text-red-600 cursor-pointer ">
                                              ...
                                              <div className="mt-3  sm:mt-2">
                                                <div className="  flex flex-col">
                                                  ...
                                                  <h3 className="lg:text-2xl  text-xl font-medium leading-6 text-gray-900" id="headlessui-dialog-title-:rc:" data-headlessui-state="open">
                                                   { eachMenuItem?.name}
                                                  </h3>
                                                  <h3 className="text-sm  font-normal leading-6 text-gray-900" id="headlessui-dialog-title-:rd:" data-headlessui-state="open"></h3>
                                            ...
                                            <div className="mt-5  border-black sm:mt-6 sm:flex lg:justify-between sm:gap-3">
                                              <div className="card-list-uper">
												...
												<svg className="w-8 h-8 p-1 cursor-pointer  border-2 border-black rounded-full" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19 12.998H5v-2h14z"/></svg>
                                                  <span className="m-2">1</span>
                                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8 p-1 cursor-pointer  border-2 border-black rounded-full">
