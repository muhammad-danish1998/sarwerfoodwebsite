    ...
    <Disclosure as="nav" className="bg-transparent relative">
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel className="lg:hidden absolute left-0 m-0 w-full bg-white ">
            <div className="space-y-1 px-2 pt-2 pb-3">
              <Disclosure.Button className="block rounded-md px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-700 hover:text-white">
                {t('Login')}
              </Disclosure.Button>
              <Disclosure.Button
                as="a"
              ...
              <Disclosure.Button
                ...
                className="block rounded-md px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-700 hover:text-white"
              >
                <img className="h-10 w-10 rounded-full border-2 border-white " src="/png/uk-circle.png " />
              </Disclosure.Button>
            </div>
          </Disclosure.Panel>
        </>
